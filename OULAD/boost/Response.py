...
class Response:
    def __init__(self,args):
        ...
        self.sensitive_attribute=info["sensitive_attribute"]
    ...
    def find_groups(self):
        ...
        for candidate in self.candidates:
            current_group.add(self.train_data["region"][candidate])
    ...
    def feedback_calculator(self):
        ...
        for candidate in self.candidates:
            if self.train_data[self.sensitive_attribute][candidate]==best_group:
            ...
            elif self.train_data[self.sensitive_attribute][candidate]==worst_group:
                self.feedback[candidate]=self.p_s+self.omega if abs(self.p_s+self.omega-self.v)>abs(self.p_s-self.omega-self.v) else self.p_s+self.omega
            #else:
